...
namespace DSCApi.Modules
{
    public class EncryptModule
    {
        ...
        //ENCRYPT_SECRET_KEY
        public static string passPhrase = ConfigurationManager.AppSettings["ENCRYPT_SECRET_KEY"];
        ...
        public static string GeneratePassword()
        {
            ...
            string caracteres = "a0b1cd2ef3gh4ij5kl6mn7opq8rst9vwxyz";
            Random ramd = new Random();
            for (short i = 0; i < 8; i++)
            {
                resultado += caracteres[ramd.Next(caracteres.Length)];
            }
            return resultado;
        }
